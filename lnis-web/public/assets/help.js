const HELP_TEXT = new Map([
    ...
    ['#error-count', 'Test B/C에서는 각 대상 AFS 프레임의 손상 비트 수(1~5,880), Test D에서는 68비트 동기 패턴 안에서 손상할 비트 수(1~68)입니다.'],
    ['#error-seed', '같은 오류 위치를 재현하기 위한 난수 시작값입니다. 같은 Seed는 같은 오류 패턴을 만듭니다.'],
    ['#sync-interval', 'Test D에서 첫 프레임부터 몇 프레임마다 동기 패턴을 손상할지 정합니다. 다음 정상 프레임의 복구 여부를 확인해야 하므로 마지막 프레임은 손상하지 않습니다.'],
