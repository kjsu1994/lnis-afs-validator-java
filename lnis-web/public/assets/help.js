const HELP_TEXT = new Map([
    ...
    ['#test-type', '정상 전송, 오류 주입, 동기 복구 또는 패킷 손실 등 수행할 시험 시나리오입니다.'],
    ...
    ['#repeat-count', '패킷 손실에 대비해 각 시험 데이터그램을 반복 전송하는 횟수입니다.'],
    ['#result-timeout', '전송 완료 후 Receiver의 최종 결과를 기다리는 최대 시간(초)입니다.'],
    ['#error-count', '오류 시험에서 의도적으로 손상시킬 데이터 위치 또는 프레임의 개수입니다.'],
    ['#error-seed', '같은 오류 위치를 재현하기 위한 난수 시작값입니다. 같은 Seed는 같은 오류 패턴을 만듭니다.'],
    ['#sync-interval', '동기 복구 시험에서 SP 동기 정보를 손상시킬 간격입니다.'],
    ['#drop-rate', 'UDP Drop 시험에서 의도적으로 전송하지 않을 패킷의 비율입니다.'],
    ['#drop-seed', '같은 UDP 손실 패턴을 재현하기 위한 난수 시작값입니다.'],
    ...
    ['#test-conditions', 'Receiver가 전달받은 오류 주입, 반복 전송 등 현재 시험 조건입니다.'],
    ...
    ['#metrics', '수신량, 프레임 수, 오류율 등 시험에서 계산된 세부 측정값입니다.'],
