 ...
 *
 * <p>frame sequence와 중복 copy index를 seed와 혼합하므로 반복 실행에서도 같은 packet이 누락된다. 실제 네트워크에서 임의로 버리는 대신 송신
 * 전에 판단해 Test E 결과를 재현 가능하게 만든다.
 */
public final class AfsDropSimulator {
  ...
  public static boolean shouldDrop(
      long frameSequence, int copyIndex, double ratePercent, int seed) {
