...
public class AgentWebSocketHandler extends TextWebSocketHandler {
    ...
    {
        agentConnectionRegistry.register(agentId(session), session);
    }
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message)
            throws Exception
    {
        Envelope envelope = objectMapper.readValue(message.getPayload(), Envelope.class);
        ...
        agentMessageService.handle(envelope);
    }
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status)
    {
        ...
        agentConnectionRegistry.remove(agentId(session), session);
    }
