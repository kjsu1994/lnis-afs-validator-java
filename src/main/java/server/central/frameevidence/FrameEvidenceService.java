...
public class FrameEvidenceService {
    ...
    {
        validate(evidence);
        frameEvidenceRepository.save(sessionId, role, evidence);
    }
        ...
        StringBuilder csv =
                new StringBuilder(
                        "FrameIndex,DecoderCompleted,FullyDecoded,SB2CrcValid,SB3CrcValid,SB4CrcValid,"
                            ...
                            + "ReferenceToTransmittedBits,TransmittedToReceivedBits,ReferenceToReencodedBits,ReferenceSha256,TransmittedSha256,ReceivedSha256,ReencodedSha256,Interpretation\r\n");
    ...
    private Map<Integer, EnumMap<AgentRole, FrameEvidenceMessage>> group(UUID sessionId)
    {
        ...
        for (FrameEvidenceEntity entity : frameEvidenceRepository.findAll(sessionId)) {
            grouped.computeIfAbsent(entity.frameIndex(), ignored -> new EnumMap<>(AgentRole.class))
