...
public class ArtifactController {
    ...
    private final CombinedArtifactService combinedArtifactService;
        ...
        return ResponseEntity.ok()
                ...
                .header(
                        ...
                        ContentDisposition.attachment()
                                ...
                                .build()
                                .toString())
                .body(combinedArtifactService.create(sessionId, fileName));
    }
            ...
            @PathVariable String fileName)
    {
        ...
        return ResponseEntity.ok()
                ...
                .body(artifactService.create(sessionId, agentRole, fileName));
    }
}
