...
import server.codec.GrawCodec;
import server.model.AgentProtocol.FrameEvidenceMessage;
import server.model.LnisModels.AgentRole;
import server.model.LnisModels.AgentState;
import server.model.LnisModels.InputKind;
import server.model.LnisModels.SessionState;
import server.model.LnisModels.TestType;
import server.model.LnisModels.Verdict;
import server.agent.entity.AgentEntity;
import server.agent.repository.AgentRepository;
import server.frameevidence.repository.FrameEvidenceRepository;
import server.input.service.GrawFileStorage;
...
import server.session.repository.ActiveSessionLockRepository;
  ...
  void persistsIncreasingEventSequenceAndSessionStream() {
    ...
    var first =
        eventService.publish(
            server.model.AgentProtocol.EventType.SESSION_STATUS,
            null,
            null,
            sessionId,
            "first");
    var second =
        eventService.publish(
            server.model.AgentProtocol.EventType.RESULT,
            null,
            null,
            sessionId,
            "second");
